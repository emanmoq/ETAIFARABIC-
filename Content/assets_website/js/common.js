...
$(document).ready(function() {
	...
	$('#menu .dropdown-menu').each(function() {
		...
		var i = (dropdown.right + $(this).outerWidth()) - (menu.right + $('#menu').outerWidth());
		...
		$.ajax({
			...
			success: function(json) {
                ...
                if (json.success) {
					...
					setTimeout(function () {
						$('#cart > button').html('<div class="cimg"><svg width="35px" height="35px"><use xlink:href="#hcart"></use></svg><span id="carts">' + json['total'] + '</span></div><div class="discri text-right"><div id="cart-text" class="text-capitalize mcart hidden-sm-down">my cart</div></div>');
					 }, 100);
